%w{client product order order_item}.each {|file| require "./#{file}"}

Product.create name: "Ski de pistes", description: "Pour débutants", price: BigDecimal('327.50')
Product.create name: "Ski de fonds", description: "Pour les endurants", price: BigDecimal('99.95')
