...
Afin de prouvez que vos classes et leurs associations fonctionnent, vous allez:
...
De plus afficher les produits commandé par quantité de plus de 50 pièces.
...
Ajouter les tables, les modèles et les associations.
